...
import pic from "@/public/photo.jpg"; // Adjust this path based on your project structure
...
export default function Intro() {
  ...
  return (
    ...
    >
      ...
      <motion.div
        className="mb-10 mt-4 px-4 space-y-4"
        initial={{ opacity: 0, y: 100 }}
        animate={{ opacity: 1, y: 0 }}
      >
        <h1 className="text-2xl sm:text-4xl font-medium !leading-[1.5]">
          <span className="font-bold">Hello, I'm Teja Karthik G</span>{" "}
          <span className="text-gray-700 dark:text-gray-200">(Ken)</span>
        </h1>
        <p className="text-lg sm:text-xl text-gray-700 dark:text-gray-200 leading-relaxed">
          I'm an <span className="font-semibold">AI/ML specialist</span> with expertise in{" "}
      ...
      >
        ...
        <a
          className="group bg-white/80 dark:bg-white/10 px-7 py-3 flex items-center gap-2 rounded-full outline-none focus:scale-110 hover:scale-110 active:scale-105 transition cursor-pointer borderBlack dark:text-white/60"
          href="/CV.pdf"
          download
        >
          Download CV{" "}
